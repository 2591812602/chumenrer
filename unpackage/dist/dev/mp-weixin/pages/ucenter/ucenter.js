...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.t($options.userInfo.nickname || $options.userInfo.username || $options.userInfo.mobile)
  } : {
    f: common_vendor.t(_ctx.$t("mine.notLogged"))
  }, {
    g: common_vendor.o((...args) => $options.toUserInfo && $options.toUserInfo(...args)),
    h: common_vendor.f($data.gridList, (item, index, i0) => {
      return {
        a: "b6546e32-4-" + i0 + "," + ("b6546e32-3-" + i0),
        b: common_vendor.p({
          color: "#007AFF",
          type: item.icon,
          size: "26"
    ...
    j: common_vendor.f($data.ucenterList, (sublist, index, i0) => {
      return {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b6546e32"], ["__file", "D:/Hbuilder project/出门儿v1.1/pages/ucenter/ucenter.vue"]]);
