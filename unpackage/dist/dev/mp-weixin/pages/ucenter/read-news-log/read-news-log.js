...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "2e85923b-3-" + i0 + "-" + i1 + "," + ("2e85923b-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "2e85923b-2-" + i0 + "-" + i1 + "," + ("2e85923b-1-" + i0)
          };
        }),
        b: "2e85923b-1-" + i0 + ",2e85923b-0",
        c: "2e85923b-4-" + i0 + ",2e85923b-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "2e85923b-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder project/出门儿v1.1/pages/ucenter/read-news-log/read-news-log.vue"]]);
