...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.sr("shortCode", "88acc7a0-4,88acc7a0-3"),
    ...
    v: common_vendor.sr("form", "88acc7a0-0"),
    w: common_vendor.p({
      value: $data.formData,
      ["err-show-type"]: "toast"
    }),
    x: common_vendor.sr("popup", "88acc7a0-9"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder project/出门儿v1.1/uni_modules/uni-id-pages/pages/retrieve/retrieve-by-email.vue"]]);
