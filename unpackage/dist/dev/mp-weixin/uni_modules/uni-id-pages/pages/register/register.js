...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("captcha", "2d739b93-10,2d739b93-9"),
    v: common_vendor.o(($event) => $data.formData.captcha = $event),
    w: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    x: common_vendor.sr("agreements", "2d739b93-11,2d739b93-0"),
    y: common_vendor.p({
      scope: "register"
    }),
    ...
    D: common_vendor.sr("form", "2d739b93-0"),
    E: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder project/出门儿v1.1/uni_modules/uni-id-pages/pages/register/register.vue"]]);
