...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("shortCode", "49f2b760-10,49f2b760-9"),
    ...
    y: common_vendor.sr("agreements", "49f2b760-11,49f2b760-0"),
    z: common_vendor.p({
      scope: "register"
    }),
    ...
    E: common_vendor.sr("form", "49f2b760-0"),
    F: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder project/出门儿v1.1/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
