  ...
  return {
    ...
    d: common_vendor.f($data.weekdays, (item, index, i0) => {
      return common_vendor.e({
        ...
        e: "191404ce-2-" + i0 + ",191404ce-0",
        f: common_vendor.p({
          color: "#FFFFFF",
          type: "closeempty"
        })
      } : {
        g: "191404ce-3-" + i0 + ",191404ce-0",
        h: common_vendor.p({
          type: "checkmarkempty",
          color: "#FFFFFF"
        })
    ...
    g: common_vendor.sr("popup", "191404ce-0"),
    h: common_vendor.p({
      type: "center"
    })
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder project/出门儿v1.1/uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue"]]);
