...
const pages = [
  ...
  {
    path: "pages/haoyouliebiao/haoyouliebiao",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/searchhaoyou/searchhaoyou",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  list: [
    {
      ...
      iconPath: "static/tabbar/社区 (1).png",
      selectedIconPath: "static/tabbar/社区.png",
      text: "首页"
    },
    {
      pagePath: "pages/dongtai/dongtai",
      iconPath: "static/tabbar/动态 (1).png",
      selectedIconPath: "static/tabbar/动态.png",
      text: "动态"
    },
    {
      pagePath: "pages/message/message",
      iconPath: "static/tabbar/消息_o.png",
      selectedIconPath: "static/tabbar/3.1-消息.png",
      text: "消息"
    },
    {
      pagePath: "pages/ucenter/ucenter",
      iconPath: "static/tabbar/我的 (1).png",
...
const y = true, _ = "mp-weixin", v = m([]), S = _, k = m('{\n    "address": [\n        "127.0.0.1",\n        "172.17.50.127",\n        "192.168.197.1",\n        "192.168.245.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/Hbulider/HBuilderX.3.7.3.20230223/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"guorunbin","spaceId":"mp-42139b22-4102-4208-980e-906e9d132f08","clientSecret":"cbinUHi25BYHb8CMR3f+zA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__47FA139";
} catch (e2) {
...
const { loginPage: Xn, routerNeedLogin: Zn, resToLogin: es$1, needLoginPage: ts, notNeedLoginPage: ns, loginPageInTabBar: ss } = function({ pages: e2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pagesJson) {
